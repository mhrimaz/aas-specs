...
There are standardized qualifiers defined in link:https://cdd.iec.ch/cdd/iec61360-7/iec61360-7.nsf/TreeFrameset?OpenFrameSet&ongletactif=1[IEC CDD, IEC61360-7]. 
Additionally, link:https://cdd.iec.ch/cdd/iec61987/iec61987.nsf/TreeFrameset?OpenFrameSet&ongletactif=1[IEC 619897] is defining qualifiers.
